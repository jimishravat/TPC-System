...
if (isset($_POST["update-pass"])) {
    ...
    $updatePassword = $conn->query("UPDATE `company` SET `password`='$password' WHERE company_id = '$id'");
...
<head>
    ...
    <?php if ($updateSuccess == 1 || $updateFailure == 1) : ?>
        <meta http-equiv="refresh" content="3;url=http://localhost/tpc/company/settings.php" />
    <?php endif ?>
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-4 bg-c-lite-green user-profile">
                                    <div class="card-block text-center">
                                        ...
                                        <p class="f-w-600"><?php echo $_SESSION["companyUserId"] ?></p>
        ...
        $(function() {
            $("#currentPass").keyup(function() {
                ...
                var dataValues = {
                    ...
                    id: <?php echo $_SESSION["companyId"]; ?>
                }
